...
--   Application:     10031
--   Name:            CRM
--   Date and Time:   11:59 Saturday March 30, 2024
--   Exported By:     UMAR
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20240330115836'
);
...
'     else CRM.TASK_TITLE || '' - '' ||CRM.STATUS|| '' - ''||CRM.RESUME_DATE||'', ''||CRM.STAGES end   ACTIVE,',
'    ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(233297679109365709)
,p_name=>'New_2'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P56_NEW'
,p_condition_element=>'P56_NEW'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(233297772117365710)
,p_event_id=>wwv_flow_api.id(233297679109365709)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(232869176012262213)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(233297886952365711)
,p_event_id=>wwv_flow_api.id(233297679109365709)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
