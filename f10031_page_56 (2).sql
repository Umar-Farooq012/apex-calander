...
--   Application:     10031
--   Name:            CRM
--   Date and Time:   12:59 Monday April 8, 2024
--   Exported By:     UMAR
--   Flashback:       100
...
,p_last_upd_yyyymmddhh24miss=>'20240408101948'
);
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(252191564197314511)
,p_name=>'P56_USER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(232868543199262207)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(252380948830422018)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(252381046843422019)
,p_event_id=>wwv_flow_api.id(252380948830422018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
